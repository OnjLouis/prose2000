...
private:
	...
	// A plain 8086 additionally asks about stack, code and extra-segment
	// spaces.  They remain null and correctly fall back to program memory.
	address_space *m_spaces[8] = {};
};
